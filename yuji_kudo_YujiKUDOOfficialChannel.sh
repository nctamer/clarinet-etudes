...
# ROSE
#40etudes (18)
yt-dlp --yes-playlist https://www.youtube.com/playlist?list=PLYFfAh6qcxBG4lSvrd-HxITItrUlq5PmG -x --audio-format mp3 --audio-quality 0   -o "clarinet/YujiKudo_Rose40_%(playlist_index)03d_%(title)s_[%(id)s]_0000_%(duration)04d.%(ext)s"
#26 etudes
yt-dlp --yes-playlist --playlist-items 1-26 https://www.youtube.com/playlist?list=PLYFfAh6qcxBHiiFKPP9epPK3LZS4wjH8q -x --audio-format mp3 --audio-quality 0   -o "clarinet/YujiKudo_Rose26_%(playlist_index)03d_%(title)s_[%(id)s]_0000_%(duration)04d.%(ext)s"
#32 etudes
yt-dlp --yes-playlist --playlist-items 1-32 https://www.youtube.com/playlist?list=PLYFfAh6qcxBFP6f9SRAnLLjxinVdYYDuA -x --audio-format mp3 --audio-quality 0   -o "clarinet/YujiKudo_Rose32_%(playlist_index)03d_%(title)s_[%(id)s]_0000_%(duration)04d.%(ext)s"
